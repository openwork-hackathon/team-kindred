...
import { ArrowRight, Coins, Zap, TrendingDown } from 'lucide-react'
  ...
  return (
    <section className="py-10 px-6 sm:px-12" id="leaderboard">
      ...
      <div className="bg-[#0f0f11] border-t border-[#2a2a2e] font-mono text-[11px]">
        ...
        {/* Rows - Compact */}
        {[
          { rank: 1, name: 'Uniswap', ticker: '$UNI', score: 98.4, change: '+12.5%' },
          { rank: 2, name: 'Aave', ticker: '$AAVE', score: 92.1, change: '+5.2%' },
          { rank: 3, name: 'Hyperliquid', ticker: '$HYPE', score: 87.9, change: '+24.8%' },
          { rank: 4, name: 'GMX', ticker: '$GMX', score: 76.5, change: '-2.1%' },
          { rank: 5, name: 'Jupiter', ticker: '$JUP', score: 72.3, change: '+8.4%' },
        ].map((item) => (
